...
I've tuned SQL queries in payment systems where every millisecond had a direct cost, and in [prison service platforms](/blogs/working-in-regulated-environments-hmpps) where a slow report meant a case worker waiting for information they urgently needed. The problems are different but the patterns are the same.
