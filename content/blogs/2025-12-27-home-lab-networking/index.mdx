...
Router (192.168.1.1)
    │
    ├── Synology DS118 (192.168.1.100) — wired
    ├── Raspberry Pi (192.168.1.101) — wired, running Pi-hole
    ├── Proxmox Server (192.168.1.102) — wired
    │
    └── [wireless bridge to cabin]
            │
        Cabin AP (192.168.1.2)
            │
            ├── MacBook (DHCP) — Wi-Fi
            ├── Work Laptop (DHCP) — Wi-Fi
            └── Any other cabin devices
```
