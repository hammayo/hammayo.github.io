...
This is a practical guide for that world. Before a pipeline can build and push a Docker image, the service has to actually work in a container — if you're starting from legacy .NET, [there are landmines to navigate](/blogs/containerising-legacy-dotnet) that no Dockerfile tutorial warns you about.
