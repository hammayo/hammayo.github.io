...
The other half of a productive setup is the shell environment — the dotfiles, the aliases, the automation that makes switching between machines seamless. I've written about [building that out as a proper toolkit](/blogs/bash-dev-toolkit) if that's something you're thinking about.